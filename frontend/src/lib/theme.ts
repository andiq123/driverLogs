...
export const insightTones = {
  neutral: {
    card: "border-black/[0.05] bg-[#fffefb] text-[#151712] shadow-[0_6px_18px_rgba(31,41,28,0.05)] ring-white/60",
    wash: "bg-[radial-gradient(135%_120%_at_88%_-12%,rgba(15,143,104,0.05),transparent_58%)]",
    meta: "text-[#62685e]",
    detail: "text-[#62685e]",
  ...
  good: {
    card: "border-[#bdd7c0] bg-[#eff7ea] text-[#142016] shadow-[0_6px_18px_rgba(31,41,28,0.05)] ring-white/70",
    wash: "bg-[radial-gradient(135%_120%_at_88%_-12%,rgba(15,143,104,0.16),transparent_60%)]",
    meta: "text-[#456148]",
    detail: "text-[#556a54]",
  ...
  warn: {
    card: "border-[#efd282] bg-[#fff8df] text-[#211b0a] shadow-[0_6px_18px_rgba(31,41,28,0.06)] ring-white/70",
    wash: "bg-[radial-gradient(135%_120%_at_88%_-12%,rgba(184,135,0,0.16),transparent_60%)]",
    meta: "text-[#7b5a12]",
    detail: "text-[#776224]",
  ...
  danger: {
    card: "border-[#f0b2a8] bg-[#fff0ec] text-[#26100d] shadow-[0_6px_18px_rgba(31,41,28,0.06)] ring-white/70",
    wash: "bg-[radial-gradient(135%_120%_at_88%_-12%,rgba(209,72,54,0.16),transparent_60%)]",
    meta: "text-[#9b3226]",
    detail: "text-[#855047]",
...
export const controls = {
  ...
  trigger: "relative flex h-12 w-full min-w-0 items-center justify-between gap-2 rounded-[18px] border border-black/[0.08] bg-white/92 px-3 text-left text-[15px] outline-none shadow-[inset_0_1px_0_rgba(255,255,255,0.72)] transition-[border-color,box-shadow,background-color,transform] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] hover:bg-white focus:border-black/15 focus:shadow-[0_0_0_4px_rgba(21,23,18,0.06),inset_0_1px_0_rgba(255,255,255,0.72)] aria-expanded:border-black/15 aria-expanded:shadow-[0_0_0_4px_rgba(21,23,18,0.06),inset_0_1px_0_rgba(255,255,255,0.72)]",
