...
// Two demo vehicles so the UI shows every state: a data-rich diesel (full
// insights, fuel consumption, oil/insurance/inspection tracking) and a sparse
// petrol car (low-confidence consumption, "not logged" insights, multi-vehicle
// garage + comparison). Read-only — see demo-mode.ts.
const v1 = "demo_vehicle_f10";
const v2 = "demo_vehicle_golf";

const vehicleComparison = [
  { vehicle_id: v1, name: "BMW F10 530D", amount_mdl: 17939.98, amount_eur: 879.13, amount_usd: 1032.35, entry_count: 10 },
  { vehicle_id: v2, name: "VW Golf 1.4 TSI", amount_mdl: 2378, amount_eur: 116.57, amount_usd: 136.9, entry_count: 2 },
];

const dieselTotals: MoneyTotals = {
  ...
  vehicle_totals: vehicleComparison,
  trends: [
  ...
  insights: {
    ...
    distance: {
      ...
      months: [
        ...
        { month: "2026-08", km: 555, from_odometer: 184275, to_odometer: 184830, logs: [{ label: "Petrom", odometer: 184830, category: "Fuel" }] },
      ],
    },
    spending: {
      ...
      months: [
        ...
        { month: "2026-08", mdl: 1241.36 },
      ],
      categories: [{ name: "Fuel", mdl: 1241.36, share: 100, count: 1, average_mdl: 1241.36 }],
    },
  },
};

// Sparse vehicle: exercises low-confidence and "not logged" empty states.
const petrolTotals: MoneyTotals = {
  total_expenses_mdl: 2378,
  total_expenses_eur: 116.57,
  total_expenses_usd: 136.9,
  fuel_mdl: 2378,
  maintenance_mdl: 0,
  insurance_mdl: 0,
  cost_per_km_mdl: 0,
  expense_count: 2,
  category_totals: [{ name: "Fuel", amount_mdl: 2378, amount_eur: 116.57, amount_usd: 136.9 }],
  vehicle_totals: vehicleComparison,
  trends: [
    { month: "2026-05", amount_mdl: 1200 },
    { month: "2026-06", amount_mdl: 1178 },
  ],
  insights: {
    fuel: {
      entry_count: 2,
      total_liters: 78,
      average_fill_mdl: 1189,
      average_price_per_liter_mdl: 30.49,
      average_consumption_l_per_100km: 7.31,
    ...
    distance: {
      ...
      delta_km: 0,
      trend: "first",
      monthly_average_km: 520,
      has_current: true,
      months: [{ month: "2026-06", km: 520, from_odometer: 45000, to_odometer: 45520, logs: [{ label: "Lukoil", odometer: 45520, category: "Fuel" }] }],
    },
    spending: {
      this_month_mdl: 1178,
      delta_mdl: -22,
      trend: "down",
      months: [
        { month: "2026-05", mdl: 1200 },
        { month: "2026-06", mdl: 1178 },
      ],
      categories: [{ name: "Fuel", mdl: 1178, share: 100, count: 1, average_mdl: 1178 }],
    },
  },
};
...
export const demoAppData: AppDataResponse = {
  vehicles: [
    ...
    {
      id: v2,
      plate_number: "CWE 884",
      nickname: "VW Golf 1.4 TSI",
      make: "Volkswagen",
      model: "Golf",
      year: 2019,
      engine_type: "1.4 TSI Petrol",
      vin: "WVWZZZAUZKW123456",
      preferred_fuel_type: "Super 95",
  ...
  trips: [
    {
      ...
      vehicle_id: v1,
      name: "Weekend escape",
      start_odometer: 184275,
      started_at: "2026-08-01T06:30:00Z",
      distance_km: 555,
      fuel_spend_mdl: 1241.36,
      fuel_spend_eur: 61.73,
      fuel_spend_usd: 71.8,
      fuel_liters: 42.18,
      fill_count: 1,
      average_price_per_liter_mdl: 29.43,
      cost_per_km_mdl: 2.24,
    },
    {
      id: "demo_trip_summer",
      vehicle_id: v1,
      name: "Summer road trip",
      start_odometer: 183920,
      end_odometer: 184275,
      started_at: "2026-05-24T07:30:00Z",
      ended_at: "2026-06-05T18:10:00Z",
      distance_km: 355,
      fuel_spend_mdl: 1255.62,
      fuel_spend_eur: 62.29,
      fuel_spend_usd: 72.31,
      fuel_liters: 40.09,
      fill_count: 1,
      average_price_per_liter_mdl: 31.32,
      cost_per_km_mdl: 3.54,
    },
  ],
  settings: { name: "Demo driver", default_currency: "MDL", country: "MD", compare_country: "RO" },
  user_documents: [],
  vehicle_totals: { [v1]: dieselTotals, [v2]: petrolTotals },
};
