...
export const demoAppData: AppDataResponse = {
  ...
  expenses: [
    ...
    { id: "demo_exp_5", vehicle_id: vehicleID, category: "Inspection", amount_base: 450, base_currency: "MDL", amount_mdl: 450, amount_eur: 22.29, amount_usd: 25.84, exchange_rate_date: "2026-03-12", exchange_rate_source: "Demo stamped rate", odometer: 182600, expires_date: "2027-03-12", date: "2026-03-12", description: "ITP" },
    ...
    { id: "demo_exp_2", vehicle_id: vehicleID, category: "Maintenance", amount_base: 3970, base_currency: "MDL", amount_mdl: 3970, amount_eur: 196.64, amount_usd: 228.05, exchange_rate_date: "2026-01-18", exchange_rate_source: "Demo stamped rate", odometer: 180910, service_type: "alignment", date: "2026-01-18", description: "Brake pads · Alignment" },
